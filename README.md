...
本项目描述的**卡扣连接结构**（见 `卡扣元件.step`）涉及专利申请（已受理）。
**专利权不在 Apache License 2.0 的授权范围内，权利人明确予以保留。**
...
- 个人使用（学习、研究、自用打印）
- 免费分享由本项目生成的模型文件
- 个人、家庭作坊或小微经营者自行制造并销售打印件（年销量 1000 件以内）
- 学校、教师**自行打印**、非销售性地用于课堂教学

**需另行取得授权**：

- 工业规模批量生产、商业化量产
- **制造并销售教具、玩具、训练器材等产品**（包括卖给学校）
- 就本结构提供商业化制造／授权／技术服务

> **教育用途不自动免费**：判定看主体与行为，不看用途领域。
> 老师自己打印上课 = 免费；生产教具卖给学校 = 需授权。详见 [NOTICE](NOTICE) 第 2.4 条。

> 说明：若该专利申请最终被驳回或撤回，上述专利声明自动失效，
> 本仓库即为依 Apache-2.0 授权的完整开源项目。

## 贡献

欢迎提交 Issue 与 Pull Request。开始之前请阅读：

- [CONTRIBUTING.md](CONTRIBUTING.md) —— 开发环境、测试、代码约定
- [CLA.md](CLA.md) —— **提交 PR 前需先同意贡献者许可协议**

> 本项目采用 CLA，以便在将来能够就卡扣结构向规模化生产厂商进行
> 商业授权。仅反馈问题不需要签署。
